(function(M,re){typeof exports=="object"&&typeof module<"u"?re(exports):typeof define=="function"&&define.amd?define(["exports"],re):(M=typeof globalThis<"u"?globalThis:M||self,re(M.NeutralToken={}))})(this,function(M){"use strict";const _e={version:"0.1.6"};let ue=_e.version,Re=!1;if(typeof document<"u"){const n=document.currentScript?.src||"";(n.startsWith("http://localhost")||n.startsWith("https://localhost")||n.startsWith("/")||window.location.hostname==="localhost"||window.location.protocol==="file:")&&(Re=!0);const i=n.match(/@neutraltoken\/core@(.*?)(\/|$)/);i&&i[1]?ue=i[1]:n.includes("@latest")&&(ue="latest")}const v=Re?"./dist":`https://cdn.jsdelivr.net/npm/@neutraltoken/core@${ue}/dist`;function lt(n,i){return new Promise((s,u)=>{if(!document.getElementById("neutraltoken-css")){const a=document.createElement("link");a.id="neutraltoken-css",a.rel="stylesheet",a.href=`${v}/neutraltoken.css`,v==="./dist"&&(a.onerror=function(){this.onerror=null,this.href="https://cdn.jsdelivr.net/npm/@neutraltoken/core@latest/dist/neutraltoken.css"}),document.head.appendChild(a)}const l=document.createElement("div");l.className="pb-overlay";const d=document.createElement("img");d.src=`${v}/logo.png`,d.alt="NeutralToken logo",v==="./dist"&&(d.onerror=function(){this.onerror=null,this.src="https://cdn.jsdelivr.net/npm/@neutraltoken/core@latest/dist/logo.png"}),l.innerHTML=`
      <div class="pb-modal">
      </div>
